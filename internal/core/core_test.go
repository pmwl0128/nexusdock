...
func TestEnsureSchemaIsIdempotentAndPersistent(t *testing.T) {
	...
	for _, table := range []string{"agentdock_devices", "agentdock_pairing_codes", "agentdock_tool_contracts", "agentdock_published_tool_contracts", "oauth_clients", "oauth_authorization_codes", "oauth_grants", "oauth_refresh_token_history", "runtime_ai_settings", "runtime_ai_setting_secrets"} {
		var name string
