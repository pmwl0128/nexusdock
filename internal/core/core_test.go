...
func TestEnsureSchemaIsIdempotentAndPersistent(t *testing.T) {
	...
	for _, table := range []string{"agentdock_devices", "agentdock_pairing_codes", "agentdock_tool_contracts", "agentdock_published_tool_contracts", "runtime_ai_settings", "runtime_ai_setting_secrets"} {
		var name string
